              ...
              {projects.map(project => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* MOBILE: stack label above bars. DESKTOP: side by side */}
                    <div style={{ padding: "14px 16px" }} className="roadmap-row">
                      ...
                      <div className="roadmap-label">
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                          ...
                          <span style={{ fontSize: "10px", color: "var(--muted)" }}>v{project.version || "1.0"}</span>
                          {/* OPS link visible inline on mobile */}
                          <Link href={`/projects/${project.id}`} style={{
                            fontSize: "10px", color: "var(--cyan)", textDecoration: "none",
                            letterSpacing: "1px", marginLeft: "4px",
                          }} className="mobile-ops-link">
                            OPS →
                          </Link>
                        </div>
                      </div>
                      ...
                      <div className="roadmap-timeline">
                        {versionGroups.length === 0 ? (
                          ...
                          versionGroups.map((group, gi) => (
                            <div key={gi} style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
                              <span style={{
