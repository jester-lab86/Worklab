...
export default function AnalyticsChatPanel({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: `PORTFOLIO INTEL online. I have full visibility across all ${projects.length} operations. What do you need, operator?`,
    },
  ]);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: "10px", color: "var(--muted)", marginTop: "2px" }}>
              {projects.length} operations in scope
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div style={{
          ...
          {[
            ...
            "Where is my portfolio stalling?",
            ...
            <button
              ...
              style={{
                ...
                color: "var(--muted)", cursor: "pointer", fontFamily: "var(--font-jetbrains)",
