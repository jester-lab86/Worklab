...
export default function NewProject() {
  ...
  async function handleSave() {
    ...
    console.log("Parsed project:", JSON.stringify(parsed, null, 2));
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px 32px" }}>
        ...
        <div
          ...
          style={{
            ...
            cursor: "pointer", marginBottom: "32px", transition: "all 0.2s",
            background: dragover ? "var(--cyan-dim)" : "transparent",
          }}
        >
          <div style={{ fontSize: "32px", marginBottom: "12px" }}>📄</div>
          <div style={{ fontFamily: "var(--font-syne)", fontSize: "16px", fontWeight: 700, color: "var(--text)", marginBottom: "6px" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <button
            ...
            style={{
              ...
              color: "var(--cyan)", fontFamily: "var(--font-jetbrains)", fontSize: "11px",
        ...
        {markdown && (
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
              ...
              <button onClick={() => setMarkdown("")} style={{ background: "none", border: "none", color: "var(--muted)", fontSize: "11px", cursor: "pointer", fontFamily: "var(--font-jetbrains)" }}>
                Clear ✕
              </button>
            </div>
            <textarea
