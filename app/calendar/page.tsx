    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)" }}>
      ...
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 16px", height: "56px", borderBottom: "1px solid var(--border)", background: "var(--surface)", position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          ...
          <span style={{ fontSize: "11px", color: "var(--muted)", letterSpacing: "1px", fontFamily: "var(--font-jetbrains)" }}>OPS CALENDAR</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <Link href="/roadmap" style={{ padding: "6px 12px", border: "1px solid var(--border)", borderRadius: "2px", color: "var(--muted)", fontFamily: "var(--font-jetbrains)", fontSize: "11px", textDecoration: "none", letterSpacing: "1px" }}>ROADMAP</Link>
          <ThemeToggle />
        </div>
      </header>
